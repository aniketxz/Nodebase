...
export const OPENAI_MODELS = [
	...
	{ value: "gpt-5.4-pro", label: "GPT-5.4-pro (Most precise)" },
	{ value: "gpt-5.4-mini", label: "GPT-5.4-mini (Fast + cheap)" },
	{ value: "gpt-5.3", label: "GPT-5.3" },
	{ value: "gpt-5.2", label: "GPT-5.2" },
	{ value: "gpt-5.2-pro", label: "GPT-5.2-pro" },
	{ value: "gpt-5-mini", label: "GPT-5-mini (Very fast)" },
	{ value: "gpt-4.1", label: "GPT-4.1 (Older but reliable)" },
	{ value: "gpt-4.1-mini", label: "GPT-4.1-mini" },
] as const;

export type ModelId = (typeof OPENAI_MODELS)[number]["value"];
